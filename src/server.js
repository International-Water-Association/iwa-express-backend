...
const PROXY_TOKEN_ROUTES = [
  ...
  {method:'POST',path:'/event-registration/check-recent-sales-order'},
  ...
  { method: "POST", path: "/others/av-auth/admin/session-credential" },
  { method: "POST", path: "/others/av-auth/admin/revoke-credential" },
  { method: "POST", path: "/others/av-auth/room/login" },
  { method: "POST", path: "/others/av-auth/room/validate" },
  { method: "POST", path: "/others/av-auth/room/logout" },
